# -*- coding: utf-8 -*-
# Generated by Django 1.11.24 on 2019-09-25 14:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('waiting', 'در انتظار'), ('preparation', 'در حال آماده سازی'), ('ready', 'آماده شده'), ('delivered', 'تحویل داده شده')], default='waiting', max_length=20, verbose_name='وضعیت')),
                ('delivery_method', models.CharField(blank=True, choices=[('in_shop', 'در فروشگاه'), ('take_away', 'بیرون بر')], default='in_shop', max_length=20, null=True, verbose_name='نحوه تحویل')),
                ('delivery_address', models.TextField(blank=True, null=True, verbose_name='آدرس تحویل')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_set', to=settings.AUTH_USER_MODEL, verbose_name='مشتری')),
            ],
            options={
                'verbose_name': 'سفارش',
